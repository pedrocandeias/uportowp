...
isset($body_mobile_font_size_scale)  == (0 == (float) $b['body-font']['font-size'] || 0 == (float) isset($b['body-mobile-font']['font-size']) ) ? 1 : ( (float) isset($b['body-mobile-font']['font-size']) / (float) $b['body-font']['font-size'] );
isset($body_mobile_line_height_scale) == ( 0 == (float) $b['body-font']['line-height'] || 0 == (float) isset($b['body-mobile-font']['line-height']) ) ? 1 : ( (float) isset($b['body-mobile-font']['line-height']) / (float) $b['body-font']['line-height'] );
...
<?php if ( (float) 1 !== (float) isset($body_mobile_font_size_scale) || (float) 1 !== (float) isset($body_mobile_line_height_scale) ) : ?>
	@media (max-width: 575px) {
		body {
			<?php if ( isset($b['body-font']['font-size']) ) : ?>
				font-size: <?php echo round( (float) $b['body-font']['font-size'] * isset($body_mobile_font_size_scale), 4 ); ?>px;
			<?php endif; ?>
			<?php if ( isset($b['body-font']['line-height'] )) : ?>
				line-height: <?php echo round( (float) $b['body-font']['line-height'] * isset($body_mobile_line_height_scale), 4 ); ?>px;
			<?php endif; ?>
			<?php if ( isset($b['body-mobile-font']['letter-spacing'] )) : ?>
				letter-spacing: <?php echo esc_html( $b['body-mobile-font']['letter-spacing'] ); ?>;
			<?php endif; ?>
		}
		h1 {
			<?php if ( $b['h1-font']['font-size'] ) : ?>
				font-size: <?php echo round( (float) $b['h1-font']['font-size'] * isset($body_mobile_font_size_scale), 4 ); ?>px;
			<?php endif; ?>
			<?php if ( $b['h1-font']['line-height'] ) : ?>
				line-height: <?php echo round( (float) $b['h1-font']['line-height'] * isset($body_mobile_line_height_scale), 4 ); ?>px;
			<?php endif; ?>
		}
		h1.big {
			<?php if ( $b['h1-font']['font-size'] ) : ?>
				font-size: <?php echo round( (float) $b['h1-font']['font-size'] * isset($body_mobile_font_size_scale) * 1.6154, 4 ); ?>px;
			<?php endif; ?>
			<?php if ( $b['h1-font']['line-height'] ) : ?>
				line-height: <?php echo round( (float) $b['h1-font']['line-height'] * isset($body_mobile_line_height_scale) * 1.2273, 4 ); ?>px;
			<?php endif; ?>
		}
		<?php for ( $i = 2; $i <= 6; $i++ ) { ?>
			h<?php echo (int) $i; ?> {
				<?php if ( $b[ 'h' . $i . '-font' ]['font-size'] ) : ?>
					font-size: <?php echo round( (float) $b[ 'h' . $i . '-font' ]['font-size'] * isset($body_mobile_font_size_scale), 4 ); ?>px;
				<?php endif; ?>
				<?php if ( $b[ 'h' . $i . '-font' ]['line-height'] ) : ?>
					line-height: <?php echo round( (float) $b[ 'h' . $i . '-font' ]['line-height'] * isset($body_mobile_line_height_scale), 4 ); ?>px;
				<?php endif; ?>
			}
		<?php } ?>
	}
...
/*------------------ general ---------------------- */
.porto-column,
.pricing-table-classic.spaced [class*="col-lg-"] { padding-left: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; padding-right: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; }
...
<?php if ( $b['search-border-radius'] ) : ?>
	...
	#header .searchform select,
	#header .searchform .selectric .label { padding: 0 15px 0 10px; }
...
<?php if ( isset($b['header-top-bottom-border']['border-top']) && '0px' != isset($b['header-top-bottom-border']['border-top']) && 'menu-hover-line' == $b['menu-type'] ) : ?>
	#header .header-top + .header-main {
		border-top: <?php echo esc_html( isset($b['header-top-bottom-border']['border-top']) ); ?> solid <?php echo esc_html( isset($b['header-top-bottom-border']['border-color']) ); ?>;
	}
	.header-top + .header-main .menu-hover-line > li.menu-item > a:before { height: <?php echo esc_html( isset($b['header-top-bottom-border']['border-top']) ); ?>; top: -<?php echo esc_html( isset($b['header-top-bottom-border']['border-top']) ); ?>; }
...
<?php endif; ?>
<?php if ( 'simple' == $b['search-layout'] ) : ?>
	#header .searchform-popup .search-toggle { width: 1.4em; }
...
<?php if ( 10 == $header_type ) : ?>
	...
	#header .header-contact { margin: 0 10px 0 0; }
	@media (min-width: 992px) {
...
<?php elseif ( 'side' == $header_type ) : ?>
	...
	@media (min-width: 992px) {
		...
		<?php if ( 'advanced' == $b['search-layout'] ) : ?>
			...
			.header-wrapper #header .searchform button { padding: 0 9px 0 8px; }
	...
	@media (max-width: 991px) {
		...
		.header-wrapper #header .share-links { margin: 0 0 0 10px; }
	...
	<?php endif; ?>
		...
		if ( $b['mainmenu-popup-bg-color'] && 'transparent' != $b['mainmenu-popup-bg-color'] ) :
			...
			<?php else : ?>
				#header .sidebar-menu li > a
			<?php endif; ?>
				{ <?php if ( ( $main_menu_popup_bg_arr[0] * 256 + $main_menu_popup_bg_arr[1] * 16 + $main_menu_popup_bg_arr[2] ) < ( 79 * 256 + 255 * 16 + 255 ) ) : ?>
		...
		<?php if ( $b['side-menu-type'] ) : ?>
			...
			<?php if ( $b['menu-popup-font']['line-height'] ) : ?>
				#header .sidebar-menu li.menu-item > .arrow { top: <?php echo ( 14 + $b['menu-popup-font']['line-height'] - 30 ) / 2; ?>px }
			<?php endif; ?>
			<?php if ( $b['menu-font']['line-height'] ) : ?>
				#header .sidebar-menu > li.menu-item > .arrow { top: <?php echo ( 22 + $b['menu-font']['line-height'] - 30 ) / 2; ?>px }
			<?php endif; ?>
...
<?php if ( $b['border-radius'] || ( (int) $header_type >= 10 && (int) $header_type <= 17 ) || empty( $header_type ) ) : ?>
	#footer .widget_wysija_cont .wysija-input { border-radius: 30px 0 0 30px; padding-<?php echo porto_filter_output( $left ); ?>: 1rem; }
...
/* footer */
#footer .logo { margin-<?php echo porto_filter_output( $right ); ?>: <?php echo esc_html( $b['grid-gutter-width'] / 2 + 10 ); ?>px; }
...
/* shortcodes */
.porto-map-section { margin-left: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; margin-right: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; }
...
@media (min-width: 768px) {
	...
	#main.main-boxed .vc_row[data-vc-stretch-content] { margin-left: -<?php echo (int) $b['grid-gutter-width']; ?>px !important; margin-right: -<?php echo (int) $b['grid-gutter-width']; ?>px !important; max-width: <?php echo 720 + $b['grid-gutter-width']; ?>px; }
}
@media (min-width: 992px) {
	body.boxed .vc_row[data-vc-stretch-content],
...
@media (max-width: 767px) {
	body.boxed #main.wide .container .vc_row { margin-left: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; margin-right: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; padding-left: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; padding-right: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; }
}
...
body.boxed .portfolio-row.full { margin-left: -<?php echo (int) $b['grid-gutter-width']; ?>px; margin-right: -<?php echo (int) $b['grid-gutter-width']; ?>px; }
...
@media (max-width: 767px) {
	.popup-inline-content .portfolio-image.wide { margin-left: -<?php echo (int) $b['grid-gutter-width'] / 4; ?>px; margin-right: -<?php echo (int) $b['grid-gutter-width'] / 4; ?>px; }
	body.boxed .portfolio .portfolio-image.wide,
	body.boxed .portfolio hr.solid,
	body.boxed #portfolioAjaxBox .portfolio-image.wide,
	body.boxed #portfolioAjaxBox hr.solid,
	...
	#main.main-boxed #portfolioAjaxBox .portfolio-image.wide,
	#main.main-boxed #portfolioAjaxBox hr.solid,
	body.boxed .portfolio-row.full { margin-left: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; margin-right: -<?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px; }
}
...
@media (max-width: 767px) {
	...
	.portfolio-ajax-modal .vc_row[data-vc-stretch-content],
	body.boxed .portfolio-ajax-modal .vc_row[data-vc-stretch-content],
	#main.main-boxed .portfolio-ajax-modal .vc_row[data-vc-stretch-content] { padding-left: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px !important; padding-right: <?php echo esc_html( $b['grid-gutter-width'] / 2 ); ?>px !important; }
}
...
<?php if ( $b['border-radius'] ) : ?>
	...
	.thumb-info .thumb-info-type { border-radius: 2px; }
	...
	.resp-vtabs .resp-tabs-container { border-radius: 0 4px 4px 0;}
	...
	@media (min-width: 992px) {
		...
		.header-wrapper.header-side-nav #header .searchform input { border-radius: 5px 0 0 5px;}
		.header-wrapper.header-side-nav #header .searchform button { border-radius: 0 5px 5px 0;}
	}
	<?php if ( ( class_exists( 'bbPress' ) && is_bbpress() ) || ( class_exists( 'BuddyPress' ) && is_buddypress() ) ) : ?>
	...
	.tabs.tabs-bottom .nav.nav-tabs.nav-justified li:last-child .nav-link { border-radius: 0 0 5px 0; }
	@media (max-width: 575px) {
	...
	.mobile-sidebar .sidebar-toggle { border-radius: 0 6px 6px 0; }
...
<?php if ( $dark ) : ?>
	...
	.porto-history .thumb { background: transparent url(<?php echo porto_uri; ?>/images/history-thumb-dark.png) no-repeat 0 0; }
...
<?php else : ?>
	...
	.slider-title .line,
	.vc_separator .vc_sep_holder.vc_sep_holder_l .vc_sep_line,
	.vc_separator .vc_sep_holder.vc_sep_holder_r .vc_sep_line { background: rgba(0, 0, 0, 0.06); }
	hr.light { background: rgba(255, 255, 255, 0.06); }
	.porto-history .thumb { background: transparent url(<?php echo porto_uri; ?>/images/history-thumb.png) no-repeat 0 0; }
<?php endif; ?>
...
.widget.twitter-tweets .fa { color: <?php echo porto_if_dark( '#fff', $color_dark ); ?>; }
...
.widget_sidebar_menu,
.tm-collapse { border-color: <?php echo esc_html( $widget_border_color ); ?>; }
...
<?php if ( 17 == $header_type ) : ?>
	...
	<?php if ( 'advanced' == $b['search-layout'] ) : ?>
		...
		#header .main-menu-wrap .searchform-popup .searchform input { font-weight: 700; width: 200px; padding: 6px 12px 6px 22px; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset; }
		@media <?php echo porto_filter_output( $screen_large ); ?> {
			#header .main-menu-wrap .searchform-popup .searchform input,
			#header .main-menu-wrap .searchform-popup .searchform select,
		...
		#header .main-menu-wrap .searchform-popup .searchform select { font-weight: 700; width: 120px; padding:6px 12px 6px 22px; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset; }
		#header .main-menu-wrap .searchform-popup .searchform .selectric-cat { width: 120px; }
		#header .main-menu-wrap .searchform-popup .searchform .selectric .label { font-weight: 700; padding:6px 12px 6px 22px; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075) inset; }
...
<?php foreach ( $bg_gradient_arr as $bg_gradient ) : ?>
	<?php if ( isset($b[$bg_gradient[1]]) && isset($b[ $bg_gradient[2] ]['from']) && isset($b[ $bg_gradient[2] ]['to']) ) : ?>
...
<?php
	...
	$header_opacity  = ( (int) isset($b['header-opacity'] )) ? (int) isset($b['header-opacity']) : 80;
...
if ( $b['mainmenu-wrap-bg-color-sticky'] && 'transparent' != $b['mainmenu-wrap-bg-color-sticky'] ) {
	...
	$sticky_menu_bg_color = isset($b['sticky-header-bg']['background-color']);
}
?>
...
<?php echo 'transparent' == $sticky_menu_bg_color ? ', #header.sticky-header .main-menu-wrap, .fixed-header #header.sticky-header .main-menu-wrap' : ''; ?> {
	<?php if ( ! empty( $b['sticky-header-bg']['background-color'] ) && 'transparent' != $b['sticky-header-bg']['background-color'] ) { ?>
		background-color: rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg']['background-color'] ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>);
	<?php } ?>
	<?php if ( ! empty( $b['sticky-header-bg']['background-repeat'] ) ) { ?>
		background-repeat: <?php echo esc_html( $b['sticky-header-bg']['background-repeat'] ); ?>;
	<?php } ?>
	<?php if ( ! empty( $b['sticky-header-bg']['background-size'] ) ) { ?>
		background-size: <?php echo esc_html( $b['sticky-header-bg']['background-size'] ); ?>;
	<?php } ?>
	<?php if ( ! empty( $b['sticky-header-bg']['background-attachment'] ) ) { ?>
		background-attachment: <?php echo esc_html( $b['sticky-header-bg']['background-attachment'] ); ?>;
	<?php } ?>
	<?php if ( ! empty( $b['sticky-header-bg']['background-position'] ) ) { ?>
	...
	<?php } ?>
<?php if ( isset($b['sticky-header-bg-gradient']) && isset($b['sticky-header-bg-gcolor']['from']) && isset($b['sticky-header-bg-gcolor']['to']) && 'transparent' != $b['sticky-header-bg-gcolor']['from'] && 'transparent' != $b['sticky-header-bg-gcolor']['to'] ) : ?>
	background-image: -moz-linear-gradient(top, rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['from'] ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>), rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['to'] ) ); ?>, <?php echo (float) str_replace( '%', '', $b['sticky-header-opacity'] ) / 100; ?>));
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['from'] ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>)), to(rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['to'] ) ); ?>, <?php echo (float) str_replace( '%', '', $b['sticky-header-opacity'] ) / 100; ?>)));
	background-image: -webkit-linear-gradient(top, rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['from'] ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>), rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['to'] ) ); ?>, <?php echo (float) str_replace( '%', '', $b['sticky-header-opacity'] ) / 100; ?>));
	background-image: linear-gradient(to bottom, rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['from'] ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>), rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $b['sticky-header-bg-gcolor']['to'] ) ); ?>, <?php echo (float) str_replace( '%', '', $b['sticky-header-opacity'] ) / 100; ?>));
	background-repeat: repeat-x;
<?php endif; ?>
}
...
.fixed-header #header.sticky-header .main-menu-wrap {
	background-color: rgba(<?php echo esc_html( $porto_color_lib->hexToRGB( $sticky_menu_bg_color ) ); ?>, <?php echo (float) str_replace( '%', '', isset($b['sticky-header-opacity']) ) / 100; ?>);
}
<?php endif; ?>
<?php if ( ! empty( $b['sticky-header-bg']['background-image'] ) ) { ?>
	#header.header-loaded .header-main { transition: none; }
...
/* sticky header */
<?php if ( ! isset($porto_settings['show-sticky-logo']) ) : ?>
	#header.sticky-header .logo { display: none !important; }
<?php endif; ?>
<?php if ( ! isset($porto_settings['show-sticky-searchform']) ) : ?>
	#header.sticky-header .searchform-popup { display: none !important; }
<?php endif; ?>
<?php if ( ! isset($porto_settings['show-sticky-menu-custom-content']) ) : ?>
...
/* mobile panel */
<?php
	$panel_link_color = empty( isset($b['panel-link-color']['regular']) ) ? ( 'side' == isset($b['mobile-panel-type']) ? '#fff' : '#333' ) : isset($b['panel-link-color']['regular']);
?>
<?php if ( ! empty( $b['panel-bg-color'] ) ) : ?>
	<?php
	if ( 'side' == isset($b['mobile-panel-type']) ) :
		echo '#side-nav-panel';
	else :
		echo '#nav-panel .mobile-nav-wrap';
	endif;
	?> { background-color: <?php echo esc_html( isset($b['panel-bg-color']) ); ?>; }
	<?php
	if ( 'side' == isset($b['mobile-panel-type']) ) :
...
<?php if ( empty( isset($b['mobile-panel-type']) ) ) : ?>
...
<?php endif; ?>
<?php if ( ! empty( isset($b['panel-link-color']['hover']) ) ) : ?>
	<?php if ( empty( isset($b['mobile-panel-type']) ) ) : ?>
...
<?php foreach ( $theme_colors as $key => $theme_color ) : ?>
	html .list-<?php echo porto_filter_output( $key ); ?>.list-icons li .fa,
	...
	html .list-<?php echo porto_filter_output( $key ); ?>.list-icons.list-icons-style-3 li .fa,
...
<?php if ( $b['mainmenu-tip-bg-color'] ) : ?>
	...
	.menu-custom-block .tip .tip-arrow {
		color: <?php echo esc_html( $b['mainmenu-tip-bg-color'] ); ?>;
	}
<?php endif; ?>
...
<?php if ( $b['footer-heading-color'] ) : ?>
	...
	#footer .widget.twitter-tweets .fa {
