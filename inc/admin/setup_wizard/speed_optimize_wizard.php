...
if ( ! class_exists( 'Porto_Speed_Optimize_Wizard' ) ) {
	...
	class Porto_Speed_Optimize_Wizard {
		...
		public function porto_speed_optimize_wizard_welcome() {
			...
			<p class="lead" style="font-size: 14px;"><?php esc_html_e( 'This Speed Optimize Wizard is introduced to optimize all resources that are unnecessary for your site content. Some options may lead to conflicts.', 'porto' ); ?></p>
			<p><?php esc_html_e( "Return to the WordPress dashboard.", 'porto' ); ?></p>
			...
			<form action="" method="post">
				<ul>
					...
					<li>
						...
						<p><?php esc_html_e( 'By activating this option, you can use bootstrap features but only the ones U.Porto WP theme needs. This will reduce around 150KB of page size.', 'porto' ); ?></p>
					</li>
					<li>
						<label class="checkbox checkbox-inline">
						...
						<p><?php esc_html_e( 'By activating this option, you can use fontawesome icons but only the ones U.Porto WP theme needs. This will reduce around 40KB of page size.', 'porto' ); ?></p>
					</li>
				</ul>
				<p class="porto-setup-actions step">
		...
		public function porto_speed_optimize_wizard_ready() {
			...
			<h1><?php esc_html_e( 'This Website is now optimized!', 'porto' ); ?></h1>
			...
			if ( count( $plugins['all'] ) ) {
				?>
				<p style="color: #c00;"><?php esc_html_e( 'Note: You should disable below plugins while in development. They may affect your changes not applied.', 'porto' ); ?></p>
			...
			<?php } ?>
				...
				<p class="porto-setup-actions step">
					...
					<a class="button button-large" href="<?php echo esc_url( home_url() ); ?>"><?php esc_html_e( 'View the website!', 'porto' ); ?></a>
				</p>
			</form>
			<?php
		}
