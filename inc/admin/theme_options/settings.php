			...
			$general_layout_options      = array(
				...
				'fields'          => array(
					...
					array(
						...
						'desc'    => __( 'Show skin options when edit post, page, portfolio, member, event.', 'porto' ),
						'default' => true,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
					array(
						...
						'desc'    => __( 'Show skin options when edit the category of post, portfolio, member, event', 'porto' ),
						'default' => true,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'desc'           => esc_html__( 'You can use this font in some shortcodes such as heading and icon box.', 'porto' ),
						'id'             => 'custom1-font',
						'type'           => 'typography',
						'google'         => true,
						'font-style'     => false,
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'type'    => 'switch',
						'title'   => __( 'Hide Top Menu Seperator', 'porto' ),
						'default' => true,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'description' => __( 'default: 15 15 15 15', 'porto' ),
						'default'     => array(
							'padding-top'    => 15,
							'padding-bottom' => 15,
							'padding-left'   => 15,
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle'   => __( 'Whenever you change header type, related theme options such as Search Layout may be changed together according to it.', 'porto' ),
				...
				'fields'     => array(
					array(
						...
						'desc'   => wp_kses(
							...
							sprintf( __( 'Go to <a %s>View Switcher Skin Settings</a>', 'porto' ), 'href="skin-view-currency-switcher" class="goto-section"', 'porto' ),
							array(
								'a' => array(
									'href'  => array(),
									'class' => array(),
					...
					array(
						...
						'type'    => 'switch',
						'title'   => __( 'Show WPML Language Switcher HTML', 'porto' ),
						'desc'    => __( 'Show wpml language switcher html code if there isn\'t any switcher.', 'porto' ),
						'default' => false,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'required' => array( 'search-type', 'equals', array( 'post' ) ),
						'default'  => false,
						'on'       => __( 'Yes', 'porto' ),
						'off'      => __( 'No', 'porto' ),
					),
				...
				array(
					...
					'fields'     => array(
						...
						array(
							'id'     => '1',
							'type'   => 'info',
							'title'  => __( 'If header type is 1, 4, 13 or 14', 'porto' ),
							'notice' => false,
						),
						array(
							'id'      => 'menu-align',
				...
				array(
					...
					'fields'     => array(
						...
						array(
							...
							'type'    => 'switch',
							'title'   => __( 'Show Excerpt', 'porto' ),
							'desc'    => __( 'If yes, will be show the excerpt in archive layout. If no, will be show the content.', 'porto' ),
							'default' => true,
							'on'      => __( 'Yes', 'porto' ),
							'off'     => __( 'No', 'porto' ),
						),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					array(
						...
						'type'    => 'switch',
						'title'   => __( 'Show Social Links', 'porto' ),
						'desc'    => __( 'Show social links in post, page, portfolio, etc.', 'porto' ),
						'default' => true,
						'on'      => __( 'Yes', 'porto' ),
						'off'     => __( 'No', 'porto' ),
					),
