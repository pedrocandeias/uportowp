...
function porto_ct_default_view_meta_fields() {
	...
	$fields = array(
		...
		'mobile_sidebar'       => array(
			...
			'desc'    => __( 'Show Sidebar in Navigation on mobile', 'porto' ),
			'type'    => 'radio',
			'default' => '',
			'options' => porto_ct_enable_options(),
		),
	...
	if ( porto_header_type_is_preset() && '19' != porto_get_header_type() ) {
