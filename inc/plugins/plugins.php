...
if ( current_user_can( 'manage_options' ) ) {
	class PortoTGMPlugins {
		...
		array(
			...
			array(
				'name'      => 'U.Porto WP Functionality',
				'slug'      => 'uportowp-functionality',
				'source'    => porto_plugins . '/uportowp-functionality.zip',
				'required'  => true,
				'version'   => '1.0.0',
				'url'       => 'uporto-functionality/uportowp-functionality.php',
				'image_url' => porto_plugins_uri . '/images/uporto_functionality.png',
			),
			array(
				'name'      => 'Contact Form 7',
				'slug'      => 'contact-form-7',
