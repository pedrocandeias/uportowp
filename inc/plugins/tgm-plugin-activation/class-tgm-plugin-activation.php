 ...
 * @version   2.6.1 for parent theme Porto for publication on ThemeForest
...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function deacivate_update_plugin() {
			...
			if ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] && $this->is_plugin_active( $slug ) ) {
				...
				if ( ! isset( $_GET['plugin_source'] ) ) {
					$query = sprintf( '?page=%s&plugin=%s&tgmpa-update=%s&tgmpa-nonce=%s', $_GET['page'], $_GET['plugin'], $_GET['tgmpa-update'], $_GET['tgmpa-nonce'] );
				} else {
					$query = sprintf( '?page=%s&plugin=%s&tgmpa-update=%s&plugin_source=%s&version=%s&return_url=%s&tgmpa-nonce=%s', $_GET['page'], $_GET['plugin'], $_GET['tgmpa-update'], $_GET['plugin_source'], $_GET['version'], $_GET['return_url'], $_GET['tgmpa-nonce'] );
				}
		...
		protected function create_user_action_links_for_notice( $install_count, $update_count, $activate_count, $line_template ) {
			...
			// edit for porto theme
			$link_template = '<a class="button button-primary" style="margin-top:1em;" href="%2$s">%1$s</a>';
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function get_row_actions( $item ) {
			...
			if ( ! $item['minimum_version'] ) {
				...
				$action_links['register'] = '<span style="color:#666">Please</span> <a href="admin.php?page=porto">register</a> <span style="color:#666">the theme</span>';
