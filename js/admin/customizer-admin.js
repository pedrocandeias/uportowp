    ...
    $(document).ready(function() {
        ...
        wp.customize.section('porto_header_layouts') && wp.customize.section('porto_header_layouts').expanded.bind(function(t) {
            if (!t) {
                ...
                if (typeof wp.customize.instance('porto_settings[header-type-select]') == 'undefined' || wp.customize.instance('porto_settings[header-type-select]').get() != 'header_builder') {
        ...
        if (typeof $.redux != 'undefined') {
            ...
            for(var i in reduxInitializedFields) {
                if (reduxInitializedFields[i] in redux.field_objects) {
                    redux.field_objects[reduxInitializedFields[i]].init();
                }
            }
        }
