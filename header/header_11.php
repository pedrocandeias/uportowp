	...
	<div class="header-main">
		<div class="container">
			...
			<div class="header-right">
				...
				<a class="mobile-toggle<?php echo ( isset( $porto_settings['menu-toggle-bg-color'] ) && $porto_settings['menu-toggle-bg-color'] ) ? ' background-color-primary text-color-light' : ''; ?>"><i class="fa fa-reorder"></i></a>
			</div>
		</div>
