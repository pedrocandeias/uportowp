...
<article <?php post_class( $post_class ); ?>>
	...
	<div class="m-t-lg<?php echo 'widewidth' === $porto_layout ? ' container' : ''; ?>">
		...
		<div class="row">
			<div class="<?php echo 'wide-both-sidebar' == $porto_layout || 'both-sidebar' == $porto_layout ? 'col-md-12' : 'col-md-7'; ?> mt-4 mb-4">
			...
			<div class="<?php echo 'wide-both-sidebar' == $porto_layout || 'both-sidebar' == $porto_layout ? 'col-md-12' : 'col-md-5'; ?> mt-4">
				<?php
